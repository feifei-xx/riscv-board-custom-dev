# Debian VisionFive2  系统版本和工具链测试报告

## 测试环境

### 操作系统信息

- 系统版本：StarFive Debian 202510
- 下载链接：<https://github.com/starfive-tech/VisionFive2/releases>
- 参考安装文档：<https://rvspace.org/en/project/VisionFive2_Debian_User_Guide>
...
从[下载链接](https://debian.starfivetech.com/)下载所需镜像。并使用 bzip2 解压缩镜像文件
```shell
bzip2 -dk starfive-jh7110-202510-minimal-desktop-wayland.img.bz2
```
...
用 dd 刷写镜像到 sd 卡：
```shell
sudo dd if=starfive-jh7110-202510-minimal-desktop-wayland.img of=/dev/sdX bs=4M status=progress conv=fsync
```
### 登录系统
...
通过 USB 转串口转换器将 VisionFive 2 连接到主机电脑

将SD卡插入 VisionFive 2 并开机
...
[![asciicast](https://asciinema.org/a/FUkoKNxycDUpZg9E.svg)](https://asciinema.org/a/FUkoKNxycDUpZg9E)
## 预期结果
